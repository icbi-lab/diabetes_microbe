...
data<- read_tsv("/data/scratch/kvalem/projects/2024/diabetes_microbe/01-tables/materials/exchange_fluxes_all_taxa.csv")
...
# By sample data
dat_sample <- dat %>%
  group_by(sample_id, metabolite, condition,abundance,sex) %>%
  summarise(
...
# Log transform abundance in by sample data
...
## Anotate dataframe with metabolite names 
