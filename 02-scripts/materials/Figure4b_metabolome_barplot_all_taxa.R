...
data<- read_tsv("/data/scratch/kvalem/projects/2024/diabetes_microbe/01-tables/tables_01/materials/exchange_fluxes_all_taxa.csv")
...
#write.csv(data_kept, file = "/data/scratch/kvalem/projects/2024/diabetes_microbe/01-tables/tables_02/materials/metabolite_abundance_barplot_linearreg_eshighella.csv", row.names = FALSE)
